...
class MDSimulator:
    def __init__(self, master):
        ...
        self.f1_title = Label(self.f1, text="Molecular Dynamics Simulator", font="Roman 15 bold", fg="black")
        ...
        self.topology_btn = Button(self.f2, text="Generate Topology", border=5, bg="yellow", fg="black", font="Roman 11 bold", borderwidth=2, command=self.runTopology)
        self.solvate_btn = Button(self.f2, text="Define box & Solvate", border=5, bg="red", fg="black", font="Roman 11 bold", borderwidth=2, command=self.runSolvate)
        self.ions_btn = Button(self.f2, text="Add ions", border=5, bg="red", fg="black", font="Roman 11 bold", borderwidth=2, command=self.runIons)
        self.minimize_btn = Button(self.f2, text="Energy Minimization", border=5, bg="red", fg="black", font="Roman 11 bold", borderwidth=2, command=self.runMinimize)
        self.equal_btn = Button(self.f2, text="Equlibration", border=5, fg="black", bg="red", font="Roman 11 bold", borderwidth=2, command=self.runEqual)
        self.prod_btn = Button(self.f2, text="Production MD", border=5, fg="black", bg="red", font="Roman 11 bold", borderwidth=2, command=self.runProd)
        ...
        self.topology_arr = Button(self.f2, text=">", fg="black", font="Roman 12 bold", command=self.arrTopology)
        self.topology_arr.grid(row=1, column=2, padx=2, ipadx=5)
        self.solvate_arr = Button(self.f2, text=">", fg="black", font="Roman 12 bold", command=self.arrSolvate)
        self.solvate_arr.grid(row=1, column=4, padx=2, ipadx=5)
        self.ions_arr = Button(self.f2, text="v", fg="black", font="Roman 14", command=self.arrIons)
        self.ions_arr.grid(row=2, column=5, padx=2, ipadx=1, ipady=3, pady=5)
        self.minimize_arr = Button(self.f2, text="<", fg="black", font="Roman 12 bold", command=self.arrMinimize)
        self.minimize_arr.grid(row=3, column=4, padx=2, ipadx=5)
        self.equal_arr = Button(self.f2, text="<", fg="black", font="Roman 12 bold", command=self.arrEqual)
        ...
        ### -----   Buttons for running the script, clearing and exiting the program ----- ###
        self.analysis_btn = Button(self.f3, text="Analysis", fg="blue", font="Roman 11 bold", borderwidth=2, command=self.runAnalysis)
...
if __name__ == '__main__':
    ...
    root = Tk()
    root.geometry("800x320") # width x length
